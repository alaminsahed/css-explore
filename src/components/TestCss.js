        ...
        <div className=''>
            <section className="relative overflow-hidden">
                <div style={{ opacity: 1, transform: "none" }}>
                    ...
                    <span className="bg-gradient-180  from-[#58a5ff] to-[#a67af4] left-[-99px] absolute w-[44rem] h-96 top-[-227px]  rounded-full mix-blend-normal blur-2xl   dark:opacity-35 opacity-[0.15]"></span>
